...
typedef void (*worker_reduce_fold_fn)(const char *key, const char **values,
                                      size_t n_values, FILE *out);

void fold_word_count(const char *key, const char **values, size_t n_values,
                     FILE *out);
